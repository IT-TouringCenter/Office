...
@Component({
  selector: 'app-traveled-summary-manager',
  templateUrl: './traveled-summary-manager.component.html',
  styleUrls: ['./traveled-summary-manager.component.scss']
})
export class TraveledSummaryManagerComponent implements OnInit {
