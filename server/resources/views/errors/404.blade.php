<html>
	 <head>
			...
			<style>
				 ...
				 .primary-text-color {
				 color: rgba(10, 86, 250, 1) !important;
				 }
				 .secondary-text-color {
				 color: rgba(245, 5, 5, 1) !important;
				 }
				 .border-button {
	 ...
	 <body class="plain error-page-wrapper background-color background-image">
			<div class="content-container">
				 ...
				 <div class="buttons-container">
						<a class="border-button" href="http://www.icas10.tour-in-chiangmai.com" target="_blank">Go To Homepage</a>
						<a class="border-button" href="mailto:it@touringcnx.com" target="_blank">Report A Problem</a>
				 </div>
			</div>
			<script>
